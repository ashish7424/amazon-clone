...
export const footerData = [
  ...
  {
    label: "Order Info",
    value: ["FAQ", "Shipping", "Returns", "Size Charts"],
  },
  {
    label: "NEWSLETTER",
    value: ["Join our newsletter for 10% off your first order."],
  },
];
